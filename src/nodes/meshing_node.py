...
def meshing_node(state):
    ...
    if mesh_type == "custom_mesh":
        ...
        return copy_custom_mesh(state.get("custom_mesh_path"), user_requirement, case_dir, state["llm_service"])  # service
        ...
        return prepare_standard_mesh(user_requirement, case_dir, state["llm_service"])  # service
